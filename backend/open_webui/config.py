...
if default_prompt_suggestions == []:
    default_prompt_suggestions = [
        # Переведенные существующие промпты
        {
            "title": ["Помоги в изучении", "словарного запаса к предстоящему экзамену"],
            "content": "Составляй предложения с пропуском и 4 вариантами ответа по моей теме. После каждого ответа кратко поясняй правильный вариант.",
        },
        {
            "title": ["Расскажи факт", "о Римской империи с коротким объяснением значения"],
            "content": "Поделись одним любопытным фактом о Римской империи и объясни, почему он важен или необычен.",
        },
        {
            "title": ["Покажи пример", "кода липкого заголовка для сайта на CSS и JS"],
            "content": "Дай минимальный пример HTML/CSS/JS липкого заголовка: фиксируется при скролле, меняет стиль после 50px, с краткими пояснениями.",
        },
        {
            "title": ["Объясни опционы", "простыми словами для человека, знакомого с акциями"],
            "content": "Сравни опционы с акциями: колл/пут, страйк, премия, срок, риск/доходность; приведи примеры и типичные ошибки.",
        },
        {
            "title": ["Помоги с прокрастинацией", "задай вопросы и предложи персональные шаги"],
            "content": "Сначала задай 5 уточняющих вопросов о моих триггерах, затем предложи план из коротких шагов и способов отслеживания прогресса.",
        },
        
        # Бизнес-тематика
        {
            "title": ["Сделай план", "структуру бизнес-плана для IT-стартапа"],
            "content": "Сформируй оглавление: продукт, рынок, конкуренты, монетизация, план вывода, финансы, риски — и ключевые вопросы к каждому разделу.",
        },
        {
            "title": ["Проанализируй рынок", "проведи анализ конкурентов в моей нише"],
            "content": "Опиши источники данных, метрики сравнения, шаблон таблицы и шаги для выявления преимуществ и пробелов конкурентов.",
        },
        {
            "title": ["Дай стратегию", "цифрового маркетинга для малого бизнеса с бюджетом"],
            "content": "Распредели бюджет по каналам (SEO, контент, email, SMM, PPC), укажи ожидаемые метрики, приоритеты и план на первые 90 дней.",
        },
        {
            "title": ["Помоги руководить", "удалённой командой с понятными практиками"],
            "content": "Дай список инструментов, ритуалов встреч, правил асинхронности, SLA по ответам и советы по мотивации и обзорам эффективности.",
        },
        {
            "title": ["Оцени проект", "методы и показатели инвестиционной привлекательности"],
            "content": "Объясни NPV, IRR, срок окупаемости и анализ чувствительности; приведи пример расчёта и критерии принятия решения.",
        },
        
        # Аналитика и данные
        {
            "title": ["Помочь с визуализацией данных", "лучшие практики визуализации данных и дашбордов"],
            "content": "Опиши выбор диаграмм, цветовые правила, уровень детализации, аннотации и анти‑примеры с вариантами исправлений.",
        },
        {
            "title": ["Помочь с аналитикой", "полезные запросы для анализа продаж и конверсий"],
            "content": "Дай 5–7 типовых SQL‑запросов: RFM, когортный анализ, воронка, LTV, ретеншн; добавь краткие пояснения к каждому.",
        },
        {
            "title": ["Спланируй A/B тест", "правильную постановку теста и анализ результатов"],
            "content": "Опиши формулировку гипотезы, метрики, длительность, размер выборки, проверку значимости и принципы интерпретации.",
        },
        {
            "title": ["Спрогнозируй ряд", "когда выбрать ARIMA, Prophet или ML‑модели"],
            "content": "Сравни методы по сезонности, тренду и объёму данных; предложи чек‑лист выбора и пример базовой настройки.",
        },
        
        # Хобби и увлечения
        {
            "title": ["Помочь спланировать поездку", "на неделю по России с ограниченным бюджетом"],
            "content": "Составь маршрут по городам, разбивку по дням, бюджет транспорта и жилья, бесплатные активности и полезные лайфхаки.",
        },
        {
            "title": ["Помочь выучить язык", "предложи эффективные методики и план на первые 30 дней"],
            "content": "Предложи распорядок занятий, материалы, интервальное повторение, speaking‑дни и систему трекинга прогресса.",
        },
        {
            "title": ["Помоги стать шеф-поваром", "расскажи базовые техники для уверенного домашнего повара"],
            "content": "Разбери жарку, тушение, запекание, ножевые навыки и соусы‑основы; добавь список необходимого инвентаря.",
        },
        
        # Разные интересные темы
        {
            "title": ["Помоги изменить привычки", "научный подход и проверенные техники"],
            "content": "Коротко о петле привычки, триггерах и подкреплении; предложи план внедрения, если‑то правила и трекинг прогресса.",
        },
        {
            "title": ["Расскажи о космосе", "самые интересные открытия последнего года"],
            "content": "Опиши 3–4 открытия, их значение и возможные приложения; по возможности укажи ссылки на источники.",
        },
        {
            "title": ["Научи финансам", "простые основы личного инвестирования"],
            "content": "Раскрой цели, подушку, диверсификацию, индексные фонды, горизонты и риски; предложи последовательность первых шагов.",
        },
        {
            "title": ["Помоги войти в медитацию", "практики осознанности для полного новичка"],
            "content": "Опиши 10‑минутную медитацию, дыхательные техники, якоря, типичные ошибки и способы сделать практику регулярной.",
        },
        
        # Дополнительные темы
        {
            "title": ["Составь меню", "здорового питания на неделю со списком покупок"],
            "content": "Составь недельное меню с калорийностью, простыми рецептами и единым списком покупок по категориям.",
        },
        {
            "title": ["Тренировка в домашних условиях", "программа без оборудования на 4 недели"],
            "content": "Подготовь по 3 тренировки в неделю: разминка, основная часть, заминка; укажи время и целевые группы мышц.",
        },
        {
            "title": ["Подготовь резюме", "улучши CV под конкретную вакансию"],
            "content": "Разбери мои пункты, выдели достижения цифрами, адаптируй под требования вакансии и предложи итоговую структуру.",
        },
        {
            "title": ["Подготовь меня к интервью", "вопросы и задачи по Python с ответами"],
            "content": "Собери список частых вопросов по Python, алгоритмы, задачи на код с решениями и краткими пояснениями.",
        },
        {
            "title": ["Напиши речь", "структура и советы для уверенного выступления"],
            "content": "Предложи структуру речи, приёмы вовлечения, примеры открытий и завершений, а также чек‑лист репетиции.",
        },
        {
            "title": ["Советы по управлению временем", "внедрение Pomodoro и приоритетов на неделю"],
            "content": "Составь недельный план блоками Pomodoro, матрицей Эйзенхауэра и правилами переключения контекста.",
        },
        {
            "title": ["Подобери книги", "план чтения по моей теме на месяц"],
            "content": "Подбери 5–7 книг с краткими аннотациями и порядком чтения; добавь статьи и видео для дополнения.",
        },
        {
            "title": ["Помоги изучить алгебру", "дорожная карта по линейной алгебре для новичка"],
            "content": "Опиши план изучения: векторы, матрицы, преобразования, собственные значения; добавь упражнения и ресурсы.",
        },
        {
            "title": ["Проведи UX‑аудит", "быстрый чек‑лист удобства сайта"],
            "content": "Дай чек‑лист навигации, иерархии, доступности, форм и ошибок; предложи быстрые улучшения без редизайна.",
        },
        {
            "title": ["Помоги организовать встречу", "повестку, тайминг и протокол для эффективности"],
            "content": "Сделай шаблон повестки, роли участников, правила тайминга и формат протокола решений и действий.",
        },
        {
            "title": ["Оформь проект", "шаблон README и структуры документации"],
            "content": "Сгенерируй структурированный README: цели, установка, запуск, примеры, архитектура, вклад, лицензия.",
        },
        {
            "title": ["Помоги настроить Git", "рабочий процесс ветвления по GitFlow"],
            "content": "Опиши ветки main/develop/feature/release/hotfix, правила коммитов, ревью и релизный цикл.",
        },
        {
            "title": ["Помоги с безопасностью", "практики защиты аккаунтов и устройств"],
            "content": "Дай советы по паролям, менеджерам, 2FA, резервным кодам, фишингу и обновлениям; добавь чек‑лист.",
        },
        {
            "title": ["Спланируй бюджет", "простой план личных финансов на месяц"],
            "content": "Разбей доходы и траты по категориям, предложи правило 50/30/20, целевые фонды и план контроля расходов.",
        },
        {
            "title": ["Подобери подарок", "идеи с учётом интересов и бюджета"],
            "content": "Собери 10 идей под разные увлечения и бюджеты, с пояснениями и альтернативами hand‑made.",
        },
        {
            "title": ["Помоги организовать праздник", "план дня рождения с таймингом и ролями"],
            "content": "Сделай сценарий, список задач, тайминг, роли помощников, бюджет и план B на случай форс‑мажоров.",
        },
        {
            "title": ["Помоги разобраться в вакансии", "оценка требований и сопоставление с моим опытом"],
            "content": "Выдели ключевые навыки, приоритизируй требования, предложи адаптацию резюме и план закрытия пробелов.",
        },
        {
            "title": ["Составь карточки", "набор Anki по моей теме с интервалами повторения"],
            "content": "Сгенерируй 30 карточек в формате Anki (front/back), сгруппируй по подтемам и предложи интервалы повторения.",
        },
        {
            "title": ["Помоги развить карьеру", "составить дорожную карту навыков на 6 месяцев"],
            "content": "Определи целевую роль, необходимые навыки, учебные ресурсы и план практики с контрольными точками.",
        },
    ]
